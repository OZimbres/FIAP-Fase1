...
![Crise do software e seu processo de desenvolvimento](image.png)
...
>*O estudo efetuado pelo **DOD** na **década de 1990** indicou que **75%** de todos os grandes sistemas de softwares desenvolvidos falham, e a principal causa disso é a falta de gerenciamento adequado por parte do desenvolvedor e do cliente, e não em razão do desempenho técnico.<br>**- SOTILLE, 2014***
...
![Fatores do fracasso no desenvolvimento de softwares](image-1.png)

![Resultado dos projetos de sistemas de software](image-2.png)
...
![Elementos da engenharia de software](image-3.png)
...
**Ferramentas** representam o meio automatizado para a realização das taredas e permitem que as atividades sejam executadas de forma mais eficiente e eficaz.<br>Exemplo: *software* de modelagem de dados ou *softwares* para a implementação do *software*.
